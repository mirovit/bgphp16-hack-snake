...
function SnakeJS(parentElement, config){
    ...
    function InputInterface(pauseFn, resumeFn, autoPlayFn){
        ...
        this.startListening = function(){
            ...
            document.addEventListener('moveSnake', function (e) {
                // e.target matches elem
                with (constants) {
                    switch (e.detail.myCode)
                    {
                        case 37:
        ...
        var handleKeyDown = function(event){
            ...
            if (arrowKeys.indexOf(event.keyCode) >= 0) {
                ...
                if (!config.receiver) {
                    var cevent = new CustomEvent('moveSnake', {
                        detail: {
                    ...
                    // Define that  he event name is 'build'.
                    //cevent.initEvent('move', true, true, {code: event.keyCode});
